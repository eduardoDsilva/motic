            ...
            <div class="row">
                <div class="col s12 m12 l6">
                    <div class="card small red darken-3 hoverable">
                        ...
                        <div class="card-action">
                            <a class="btn" disabled href="{{route ('admin.auditoria.relatorios.todos.registros')}}">Gerar relatório</a>
                        </div>
                    </div>
                </div>
                <div class="col s12 m12 l6">
                    <div class="card small purple darken-3 hoverable">
                        ...
                        <div class="card-action">
                            <button class="modal-trigger btn" data-target="modal" href="#modal1" type="submit">Gerar relatório</button>
                        </div>
                    </div>
                </div>
                <div class="col s12 m12 l6">
                ...
                <div class="col s12 m12 l6">
                    <div class="card small blue darken-3 hoverable">
                        ...
                        <div class="card-action">
                            <button class="modal-trigger btn" data-target="modal2" href="#modal2" type="submit">Gerar relatório</button>
                        </div>
                    </div>
                </div>
