    ...
    <div class="section container">
        <div class="card-panel">
            ...
            <div class="row center">
                <h5 class="header col s12 light">Esses são os relatórios disponíveis para realizar auditoria do
                    sistema!</h5>
            </div>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="modal-trigger tooltipped" data-position="top" data-delay="50"
                                       ...
                                       href="{{route('admin.auditoria.relatorios.registro.individual', $auditoria->id)}}"><i
