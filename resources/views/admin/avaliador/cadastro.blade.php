                ...
                <article class="col s12">
                    <form method="POST" enctype="multipart/form-data" action="@if(isset($avaliador)) {{ route("admin.avaliador.update", $avaliador->user->id) }}" @else {{ route('admin.avaliador.store') }} " @endif>
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6 l12">
                                ...
                                <input id="usuario" class="validate tooltipped" data-position="top" data-delay="50" data-tooltip="Insira um usuário com até 30 caracteres"
                                       type="text" name="username" value="{{$avaliador->user->username or old('username')}}" required>
                        ...
                        <div class="fixed-action-btn">
                            <button type="submit" class="btn-floating btn-large waves-effect waves-light red tooltipped" data-position="top" data-delay="50" data-tooltip="Cadastrar"><i class="material-icons">add_circle_outline</i></button>
                        </div>
