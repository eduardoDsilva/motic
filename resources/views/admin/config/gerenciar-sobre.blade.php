...
@section('breadcrumb')
    ...
    <a href="{{route ('admin.config.gerencia.sobre')}}" class="breadcrumb">Gerenciar sobre</a>
@endsection
...
@section('conteudo-header', "Aqui você pode gerenciar os conteúdos da página 'sobre'")
