...
@section('breadcrumb')
    ...
    <a href="{{{route ('admin/aluno/home')}}}" class="breadcrumb">Projetos</a>
...
@section('conteudo')
    ...
    <div class="section container">
        <div class="card-panel">
            <h1 class="header center orange-text">{{$projeto->titulo}}</h1>
            <div class="row center">
                <h5 class="header col s12 light">Essas são todos os dados do projeto {{$projeto->titulo}}!</h5>
            </div>
        </div>
    </div>
