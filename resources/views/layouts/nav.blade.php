                        ...
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.aluno.create')}}"><i class="material-icons">add</i>Cadastrar aluno</a></li>
                ...
                <li class="white">
                    <ul class="collapsible collapsible-accordion">
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.auditoria')}}"><i class="material-icons">list</i>Listar auditorias</a></li>
                ...
                <li class="white">
                    <ul class="collapsible collapsible-accordion">
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.avaliador')}}"><i class="material-icons">list</i>Listar avaliadores</a></li>
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.avaliador.create')}}"><i class="material-icons">add</i>Cadastrar avaliador</a></li>
                ...
                <li class="white">
                    <ul class="collapsible collapsible-accordion">
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.disciplina')}}"><i class="material-icons">list</i>Listar disciplinas</a></li>
                        ...
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.escola.create')}}"><i class="material-icons">add</i>Cadastrar escola</a></li>
                ...
                <li class="white">
                    <ul class="collapsible collapsible-accordion">
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.professor')}}"><i class="material-icons">list</i>Listar professores</a></li>
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.professor.create')}}"><i class="material-icons">add</i>Cadastrar professor</a></li>
                        ...
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.projeto.create')}}"><i class="material-icons">add</i>Cadastrar projetos</a></li>
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin/avaliador/relatorios')}}"><i class="material-icons">chrome_reader_mode</i>Relatórios</a></li>
                                    <li><div class="divider"></div></li>
                                </ul>
                            </div>
                ...
                <li class="white">
                    <ul class="collapsible collapsible-accordion">
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.suplente')}}"><i class="material-icons">list</i>Listar suplentes</a></li>
                                    <li><a class="waves-effect waves-blue" href="{{route ('admin.suplente.create')}}"><i class="material-icons">add</i>Cadastrar suplentes</a></li>
                                    <li><a class="waves-effect waves-blue" href=""><i class="material-icons">chrome_reader_mode</i>Relatórios</a></li>
                                    <li><div class="divider"></div></li>
                                </ul>
                            </div>
