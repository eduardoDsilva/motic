    ...
    <div class="card-panel">
        ...
        <div class="col s12 m4 l8">
            <form method="POST" enctype="multipart/form-data"
                  action=@if(Auth::user()->tipoUser == 'escola') "{{ route('escola.professor.filtrar') }}">
                @elseif(Auth::user()->tipoUser == 'admin') "{{ route('admin.professor.filtrar') }}">@endif
                <div class="row">
        ...
        <div class="fixed-action-btn">
            <div class="fixed-action-btn">
                <a class="btn-floating btn-large waves-effect waves-light red tooltipped  modal-trigger"
                   ...
                   href=@if(Auth::user()->tipoUser == 'escola') "{{route ('escola.professor.create')}}">
                    @elseif(Auth::user()->tipoUser == 'admin') "{{route ('admin.professor.create')}}">@endif<i class="material-icons">add</i></a>
            </div>
        </div>
